    ...
    public static void carregarEntradas(List<Entrada> entradas) {
        try (BufferedReader reader = new BufferedReader(new FileReader("entradas.txt"))) {
            ...
            while ((linha = reader.readLine()) != null) {
                ...
                if (partes.length != 2) {
                    // Se a linha não puder ser dividida corretamente, exibe uma mensagem de erro e continua para a próxima linha
                    System.err.println("Erro ao dividir a linha: " + linha);
                    continue;
                }
